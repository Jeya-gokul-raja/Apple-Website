...
export default function Tv() {
  return (
    <div className="flex justify-center z-20  gap-32 absolute bg-white w-full sm:-mt-16 sm:fixed h-[470px]  text-gray-800 ">
      <ul className="font-semibold mt-6  -ml-[420px]">
