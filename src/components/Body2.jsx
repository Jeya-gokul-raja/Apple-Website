  ...
  const items = [
    {
      ...
      text2_style: "sm:text-4xl text-xl ml-2 sm:mt-4",
      text3: "",
      text3_style: "",
      text4: "Available from 12 March",
      text4_style:
        "font-semibold sm:m-4 text-gray-400 text-base m-1 sm:text-2xl",
      button1: "Learn More",
      button1_style:
        "bg-blue-500 border sm:w-42 sm:h-14 h-10 w-26 border-blue-500 p-2 text-white sm:text-2xl text-base rounded-4xl",
      button2: "Pre-order",
      button2_style:
        "hover:bg-blue-500 hover:text-white  border ml-6 border-blue-500 sm:w-42 sm:h-14 h-10 w-28 p-2 text-blue-500 sm:text-2xl text-base rounded-4xl",
      ...
      bottom_t_style: "sm:mt-[560px] mt-66 ml-7",
    },
    {
      // image:
      ...
      text2_style: "text-xl sm:text-4xl sm:mt-4",
      text3: "Choose your superpower.",
      text3_style: "text-xl sm:text-4xl sm:mt-4",
      text4: "Available from 12 March",
      text4_style:
        "sm:font-semibold sm:m-4 m-1 mb-5 text-gray-400 text-base sm:text-2xl",
      button1: "Learn More",
      button1_style:
        "bg-blue-500 border sm:w-42 sm:h-14 h-10 w-26  border-blue-500 p-2 text-white text-base sm:text-2xl rounded-4xl",
      button2: "Pre-order",
      button2_style:
        "hover:bg-blue-500 hover:text-white  border ml-6 border-blue-500 h-10 w-26 sm:w-42 sm:h-14 p-2 text-blue-500 sm:text-2xl text-base rounded-4xl",
      text5: "Build for Apple Intelligence",
      text5_style: "sm:text-3xl text-base sm:mt-4 mt-62",
      text6: " Coming in English in early April",
      text6_style: "sm:text-xl text-sm  sm:mt-2 text-gray-400",
      bottom_t_style: "sm:mt-[500px] mt-34",
    },
  ];
